        ...
        <!-- 본문 영역 -->
				<div class="col-sm-9">
					<div class="content-title mb-5">
						<div>
							<p class="float-left" style="margin: 0px">환불 내역</p>
						</div>
						<div>
							<table class="table">
								<colgroup>
								...
								<tr class="bg-light">
									<th class="content-txt-size txt-center">환불 신청일자</th>
									...
									<th class="content-txt-size txt-center">환불사유</th>
									<th class="content-txt-size txt-center">예약메뉴</th>
								</tr>
								<tr>
									<td class="content-txt-size">2020년 8월 10일</td>
									<td class="content-txt-size">아웃백</td>
									<td class="content-txt-size">카카오페이</td>
									<td class="content-txt-size">35000 원</td>
									<td class="content-txt-size">개인사유</td>
									<td class="content-txt-size">토마호크 스테이크</td>
								</tr>
							</table>
						</div>
					</div>
