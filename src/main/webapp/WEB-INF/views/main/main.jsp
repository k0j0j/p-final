				        ...
				        <div class="inner-form">
				          <div class="basic-search">
				            <div class="input-field">
				              <input id="search" name="searchValue" value="${ search.searchValue }" type="text" placeholder="주변 맛집을 찾아보세요!" />
				              <div class="icon-wrap">
	...
	<div class="container">
		<div class="row">
			...
			<div class="btn-group btn-group-justified" role="group"
				...
				<div class="btn-group btn1" role="group">
					<button type="button" class="btn btn-default" onClick="location.href ='blist.do?bType=1'" >게시판</button>
				</div>
			</div>
